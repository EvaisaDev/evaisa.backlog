    ...
    for _, action in ipairs(map)do
        ...
        for i, added_action in ipairs(added_actions)do
            ...
            if(i == 1 or Random(0, 100) > 50)then
                sprite = "mods/evaisa.backlog/content/evaisa.tmtrainer/files/corruptions/"..added_action.sprite;
            end
        ...
        local action_function = function(recursion_level, iteration)
            ...
            c.extra_entities = c.extra_entities .. "mods/evaisa.backlog/content/evaisa.tmtrainer/files/entities/spawn.xml,"

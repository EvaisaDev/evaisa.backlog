...
barrel_script = barrel_script.."}"..string.char(10)..ModTextFileGetContent("mods/evaisa.backlog/content/evaisa.objects/files/scripts/objects/populate_material_inventory.lua")

ModTextFileSetContent("mods/evaisa.backlog/content/evaisa.objects/files/scripts/objects/populate_material_inventory.lua", barrel_script)
...
local mod_id = "evaisa.difficulty" -- This should match the name of your mod's folder.
...
{
	{
		...
		settings = {
			--[[
			{
				id = "spawn_rate",
				ui_name = "Spawn Rate",
				ui_description = "Time in seconds before the director tries to respawn a enemy.",
				value_default = 60,
				value_min = 0,
				value_max = 240,
...
mod_setting_number = function( mod_id, gui, in_main_menu, im_id, setting )
	slider_length = setting.slider_length or 64
	...
	local value_new = GuiSlider( gui, im_id, mod_setting_group_x_offset, 0, setting.ui_name, value, setting.value_min, setting.value_max, setting.value_default, setting.value_display_multiplier or 1, setting.value_display_formatting or "", slider_length )
